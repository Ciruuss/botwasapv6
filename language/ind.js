...
exports.reglevelahc = (command, pushname, getLevelingLevel, sender, ahd) => {
...
${a}❏ SOBRE USUARIO${a}
 ...
 ${a}│ Rol : ${role}${a}
 ${a}╰ Registro usuario : ${_registered.length}${a}
...
exports.afkOn = (pushname, reason) => {
    return `La función AFK funciona *diaktifkan*!\n\n➸ *Username*: ${pushname}\n➸ *Razon*: ${reason}`
}

exports.afkOnAlready = () => {
    return `La función AFK se activó.`
}
